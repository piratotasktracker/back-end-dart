...
import '../../data/roles/delete_role_repository.dart';
...
class DeleteRole with PermissionCheckMixin implements IHandler{
  @override
  ...
  @override
  List<ActionPermission> get permissionsList => [ActionPermission.canDeleteRoles];

  @override
  IRepository<DBConnection, String> get repository => DeleteRoleRepository();
