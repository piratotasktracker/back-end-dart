...
class GetTask with PermissionCheckMixin implements IHandler{
  @override
  ...
  @override
  List<ActionPermission> get permissionsList => [ActionPermission.canGetTasks];

  @override
  IRepository<DBConnection, String> get repository => GetTaskRepository();
